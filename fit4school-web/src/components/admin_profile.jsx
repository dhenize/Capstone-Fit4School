...
import ASidebar from './a_sidebar/a_sidebar';
...
const AdminProfile = () => {
  ...
  // Format date for display - handles both Firestore Timestamps and serialized objects
  ...
  const fetchAdminData = async () => {
    try {
      ...
      if (storedData) {
        ...
        if (parsedData.admin_id) {
          setUserData({
            admin_id: parsedData.admin_id || 'N/A',
      ...
      if (!querySnapshot.empty) {
        ...
        const userInfo = {
          id: userDoc.id,
          admin_id: userData.admin_id || 'N/A',
        ...
        localStorage.setItem('adminData', JSON.stringify(localStorageData));
      } else {
